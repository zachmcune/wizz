...
describe('win conditions', () => {
  it('destroying the enemy HQ ends the match even if they had other buildings', () => {
    ...
    // Give player1 extra structures so old "zero buildings" logic would not trigger yet.
    sim.enqueueNow([{ type: 'build', playerId: 'player1', defId: 'attunement_spire', x: 400, y: 240 }]);
    sim.step();
    ...
    // Remaining structures are purged when HQ falls.
